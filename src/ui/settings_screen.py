...
class SettingsScreen:
    ...
    def __init__(self, screen, settings):
        ...
        self.button_mouse = Button(
            self.screen, 400, 150, 150, 50, (200, 200, 200))
        self.button_keyboard = Button(
            self.screen, 200, 150, 150, 50, (200, 200, 200))
        self.ball_color_1 = Button(
            self.screen, 300, 300, 40, 40, (200, 200, 200))
        self.ball_color_2 = Button(
            self.screen, 400, 300, 40, 40, (255, 151, 231))
        self.ball_color_3 = Button(
            self.screen, 500, 300, 40, 40, (250, 238, 108))
        self.paddle_color_1 = Button(
            self.screen, 300, 400, 40, 40, (200, 200, 200))
        self.paddle_color_2 = Button(
            self.screen, 400, 400, 40, 40, (255, 151, 231))
        self.paddle_color_3 = Button(
            self.screen, 500, 400, 40, 40, (250, 238, 108))
    ...
    def draw_screen(self):
        ...
        back_text = self.font_small.render("enter: back", 0, (200, 200, 200))
        self.screen.fill((0, 0, 0))
        settings_text = self.font_medium.render(
            "Choose settings :", 0, (200, 200, 200))
        ball_color_text = self.font_medium.render(
            "Ball color:", 0, (200, 200, 200))
        paddle_color_text = self.font_medium.render(
            "Paddle color:", 0, (200, 200, 200))
